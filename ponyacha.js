...
function ponyacha_create() {
    try {
        ...
        ponyacha_checkbox_text_error.setAttribute("id", "ponyacha_checkbox_text_error");
        ...
        ponyacha_logo.setAttribute("id", "ponyacha_logo");
        ponyacha.appendChild(ponyacha_logo);

        let ponyacha_logo_icon = document.createElement("img");
        ponyacha_logo_icon.setAttribute("id", "ponyacha_logo_icon");
        ponyacha_logo_icon.setAttribute("src", "images/roku_chan.png");
        ponyacha_logo.appendChild(ponyacha_logo_icon);

        let ponyacha_logo_text = document.createElement("div");
        ponyacha_logo_text.setAttribute("id", "ponyacha_logo_text");
...
function ponyacha_start() {
    try {
        ...
        if (ponyacha_box === null) {
            ...
            ponyacha_box_hide.setAttribute("id", "ponyacha_box_hide");
            ...
            ponyacha_box.setAttribute("id", "ponyacha_box");
            ponyacha.appendChild(ponyacha_box);

            let ponyacha_box_header = document.createElement("div");
            ponyacha_box_header.setAttribute("id", "ponyacha_box_header");
            ...
            ponyacha_box_header_description.setAttribute("id", "ponyacha_box_header_description");
            ...
            ponyacha_box_header_description_strong.setAttribute("id", "ponyacha_box_header_description_strong");
            ...
            ponyacha_box_header_image.setAttribute("id", "ponyacha_box_header_image");
            ponyacha_box_header_image.setAttribute("src", "images/" + rand_pony[1] + ".png");
            ponyacha_box_header.appendChild(ponyacha_box_header_image);

            let ponyacha_box_body = document.createElement("div");
            ponyacha_box_body.setAttribute("id", "ponyacha_box_body");
            ponyacha_box.appendChild(ponyacha_box_body);

            let ponyacha_box_body_table = document.createElement("table");
            ponyacha_box_body_table.setAttribute("id", "ponyacha_box_body_table");
            ...
            ponyacha_box_body_table_tbody.setAttribute("id", "ponyacha_box_body_table_tbody");
                ...
                try {
                    ...
                    for (let ii = 1; ii < 4; ii++) {
                        try {
                            ...
                            ponyacha_box_body_table_td.setAttribute("class", "ponyacha_box_body_table_td");
                            ...
                            ponyacha_box_body_table_tbody_td_image.setAttribute("class", "ponyacha_box_body_table_tbody_td_image");
                            ponyacha_box_body_table_tbody_td_image.setAttribute("id", i.toString() + ii.toString() + "_&_" + rand_image);
                            ponyacha_box_body_table_tbody_td_image.setAttribute("src", "images/" + rand_cat + "/" + rand_image);
                            ponyacha_box_body_table_tbody_td_image.addEventListener("click", ponyacha_check);
                            ...
                            ponyacha_box_body_table_tbody_td_checkbox.setAttribute("class", "ponyacha_box_body_table_tbody_td_checkbox_" + ii);
                            ponyacha_box_body_table_tbody_td_checkbox.setAttribute("id", "checkbox_" + i.toString() + ii.toString());
                            ponyacha_box_body_table_tbody_td_checkbox.setAttribute("src", "images/checkmark_blue.png");
            ...
            ponyacha_box_body_error.setAttribute("id", "ponyacha_box_body_error");
            ...
            ponyacha_box_footer.setAttribute("id", "ponyacha_box_footer");
            ponyacha_box.appendChild(ponyacha_box_footer);

            let ponyacha_box_footer_separator = document.createElement("div");
            ponyacha_box_footer_separator.setAttribute("id", "ponyacha_box_footer_separator");
            ponyacha_box_footer.appendChild(ponyacha_box_footer_separator);

            let ponyacha_box_footer_reload = document.createElement("img");
            ponyacha_box_footer_reload.setAttribute("id", "ponyacha_box_footer_reload");
            ponyacha_box_footer_reload.setAttribute("src", "images/refresh_2x.png");
            ...
            ponyacha_box_footer_confirm.setAttribute("id", "ponyacha_box_footer_confirm");
            ponyacha_box_footer_confirm.setAttribute("type", "button");
            ponyacha_box_footer_confirm.setAttribute("value", "Проверить");
    ...
    try {
        if (select_list.length === 0) {
            ...
            if (JSON.stringify(chek_list.sort()) === JSON.stringify(select_list.sort())) {
                ...
                ponyacha_label.setAttribute("id", "ponyacha_label");
                ponyacha.appendChild(ponyacha_label);

                let input = document.createElement("input");
                input.setAttribute("name", "ponyacha");
                input.setAttribute("type", "hidden");
                input.setAttribute("value", "ponyacha");
