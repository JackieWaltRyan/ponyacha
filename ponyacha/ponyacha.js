...
function ponyacha_create() {
    try {
        ...
        ponyacha_checkbox_logo.src = "ponyacha/images/checkbox.png";
        ...
        ponyacha_checkbox_spinner.src = "ponyacha/images/spinner.png";
        ...
        ponyacha_checkbox_check.src = "ponyacha/images/checkmark.png";
        ...
        ponyacha_logo_icon.src = "ponyacha/images/roku_chan.png";
...
function ponyacha_start() {
    try {
        ...
        if (ponyacha_box === null) {
            ...
            ponyacha_box_header_image.src = "ponyacha/images/" + rand_pony[1] + ".png";
                ...
                try {
                    ...
                    for (let ii = 1; ii < 4; ii++) {
                        try {
                            ...
                            ponyacha_box_body_table_tbody_td_image.src = "ponyacha/images/" + rand_cat + "/" + rand_image;
                            ...
                            ponyacha_box_body_table_tbody_td_checkbox.src = "ponyacha/images/checkmark_blue.png";
            ...
            ponyacha_box_footer_reload.src = "ponyacha/images/refresh_2x.png";
